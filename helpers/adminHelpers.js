...
module.exports = {
    ...
    addSubCategory: (subCategoryDetails) => {
        return new Promise(async (resolve, reject) => {
            ...
            let subcat = await subCategoryModel.findOne({ subcategoryname: subcategoryname })
            if (subcat) {
                status.check = true
                resolve(status)
            } else {
    ...
    addProduct: (productDetails) => {
        return new Promise(async (resolve, reject) => {
            let { p_id, modelname, brand, price, description, quantity, categories } = productDetails
    ...
    updateProduct: (product) => {
        return new Promise((resolve, reject) => {
            ...
            productModel.findByIdAndUpdate(product.id, { modelname: product.modelname, brand: product.brand, price: product.price, description: product.description, quantity: product.quantity, categories: product.categories }).then((response) => {
                resolve(response)
            })
        })
    },
    ...
    getAllBanners: () => {
        return new Promise(async (resolve, reject) => {
            bannerModel.find({}).populate('product').lean().then((banners) => {
                resolve(banners)
            })
        })
    },
    ...
    editBanner: (bannerDetails) => {
        return new Promise(async (resolve, reject) => {
            ...
            bannerModel.findByIdAndUpdate(id, { banner_title: banner_title, banner_subtitle: banner_subtitle }).then((data) => {
                resolve(data)
            })
        })
    },
    ...
    changeShipping: (id, data) => {
        return new Promise((resolve, reject) => {
            orderModel.findOneAndUpdate({ _id: id }, { deliveryStatus: data.shipping }).then((data) => {
                resolve()
            }).catch((err) => {
                reject(err)
            })
